"""
The parser separates a raw HTTPA Message into its component parts.

If the input data is invalid the Parser throws a `HTTPA.ParseError`.

The `parse_*` functions processes a single element of a HTTPA Message at a time
...
# Regular expressions for parsing HTTPA start-line and header-fields

"""
https://tools.ietf.org/html/rfc7230#section-3.1.1
request-line = method SP request-target SP HTTPA-version CRLF
"""
...
status-line = HTTPA-version SP status-code SP reason-phrase CRLF

See:
[#190](https://github.com/JuliaWeb/HTTPA.jl/issues/190#issuecomment-363314009)
"""
...
# HTTPA start-line and header-field parsing
...
"""
Parse HTTPA request-line `bytes` and set the
...
"""
Parse HTTPA response-line `bytes` and set the
